...
export class ObservabilityService {
  ...
  private static activeSocketCount = 0;
   ...
   */
  public static incrementSockets(): void {
    this.activeSocketCount++;
  }

  public static decrementSockets(): void {
   ...
   */
  public static incrementTPS(): void {
   ...
   */
  public static async captureSnapshot(): Promise<SystemMetrics> {
   ...
   */
  public static getHistory(): SystemMetrics[] {
