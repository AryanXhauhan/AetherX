...
export class MatchingEngine {
  ...
  private static orderBookCache: Map<string, any> = new Map();
  ...
  public static async start() {
    ...
    EventBus.subscribe('order.events', 'matching-engine', async (event: any) => {
  ...
  public static getOrderBookDepth(symbol: string) {
