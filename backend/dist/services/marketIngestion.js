...
export class MarketIngestionService {
    static ws = null;
    static syntheticIntervals = new Map();
    static currentPrices = new Map([
        ['BTCUSDT', 67250.0],
        ['ETHUSDT', 3740.0],
        ['SOLUSDT', 165.5]
    ]);
    static isSynthetic = false;
     ...
     */
    static async fetchInitialSpotPrices() {
     ...
     */
    static startSyntheticFeeds() {
        if (this.isSynthetic)
            return; // Already running simulation
