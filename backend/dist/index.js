...
const wireEventBusBroadcasters = async () => {
    ...
    for (const sym of symbols) {
        ...
        EventBus.subscribe(tickTopic, `ws-tick-broadcaster-${sym}`, (tick) => {
        ...
        EventBus.subscribe(indicatorTopic, `ws-indicator-broadcaster-${sym}`, (data) => {
    ...
    EventBus.subscribe('order.events', 'ws-order-broadcaster', (evt) => {
